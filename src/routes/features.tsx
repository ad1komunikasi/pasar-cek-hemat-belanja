  ...
  head: () => ({
    meta: [
      { title: "Fitur Lengkap — PasarCek" },
      {
        name: "description",
        content:
          "Fitur PasarCek: cek harga sembako, bandingkan antar pasar, smart basket simulator, peta pasar terdekat, notifikasi harga, dan analitik penghematan.",
      },
      ...
      <main className="mx-auto max-w-6xl px-4 py-16">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-[var(--color-gray-500)]">
            Semua yang Anda butuhkan untuk belanja sembako lebih hemat.
          </p>
        </div>
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <Link
              ...
              to="/features/$slug"
              params={{ slug: f.slug }}
              className="rounded-lg border border-[var(--color-gray-100)] bg-white p-6 transition-colors hover:border-[var(--color-brand-blue)]"
            >
