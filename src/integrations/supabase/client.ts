...
function createSupabaseClient() {
  ...
  const SUPABASE_URL =
    cleanUrl && cleanUrl !== "undefined" && cleanUrl !== "null"
      ? cleanUrl
      : "https://nqbpykmvvjrytnwljkir.supabase.co";
  const SUPABASE_PUBLISHABLE_KEY =
    cleanKey && cleanKey !== "undefined" && cleanKey !== "null"
      ? cleanKey
      : "sb_publishable_ZftPqa-FN2fEFn6RofNDYg_cK46QKO7";
