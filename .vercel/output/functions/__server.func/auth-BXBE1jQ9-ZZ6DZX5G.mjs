...
// dist/server/assets/auth-BXBE1jQ9.js
...
function AuthPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "grid min-h-screen lg:grid-cols-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "hidden bg-gradient-navy p-12 text-white lg:flex lg:flex-col lg:justify-between relative overflow-hidden", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute -top-20 -left-20 h-96 w-96 rounded-full bg-primary/20 blur-3xl pointer-events-none" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute -bottom-20 -right-20 h-96 w-96 rounded-full bg-accent/20 blur-3xl pointer-events-none" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Link, { to: "/", className: "flex items-center gap-2 text-lg font-bold group relative z-10", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "grid h-9 w-9 place-items-center rounded-xl bg-gradient-primary text-white shadow-soft group-hover:scale-105 transition-transform duration-200", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.ShoppingBasket, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-display text-xl font-bold text-white tracking-tight", children: "PasarCek" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative z-10 my-auto flex flex-col items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "text-left w-full max-w-md", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("h1", { className: "text-5xl font-black leading-tight text-white", children: [
            "Cek Harga Dulu,",
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("br", {}),
            "Belanja Lebih Hemat."
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-6 text-white/80 text-base leading-relaxed", children: "Pantau harga sembako terbaru, bandingkan antar pasar terdekat, dan temukan keranjang belanja paling hemat hari ini." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative mt-16 w-full max-w-sm h-64 flex items-center justify-center", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute inset-0 m-auto h-48 w-48 rounded-full bg-gradient-primary opacity-20 blur-2xl animate-pulse" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative w-72 bg-white/10 backdrop-blur-md border border-white/15 rounded-2xl p-5 shadow-elevated animate-float z-10", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between mb-4 border-b border-white/10 pb-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[10px] font-bold uppercase tracking-wider text-accent-soft", children: "Simulasi Keranjang" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[10px] font-medium bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full", children: "-12% Lebih Hemat" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "space-y-3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-2.5 h-2.5 rounded-full bg-amber-400" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-medium text-white/90", children: "Minyak Goreng 2L" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "font-bold text-white", children: [
                  "Rp28.500 ",
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-white/40 line-through text-[10px]", children: "Rp32.000" })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-2.5 h-2.5 rounded-full bg-emerald-400" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-medium text-white/90", children: "Beras Premium 5kg" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "font-bold text-white", children: [
                  "Rp64.000 ",
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-white/40 line-through text-[10px]", children: "Rp69.000" })
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-2.5 h-2.5 rounded-full bg-sky-400" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-medium text-white/90", children: "Telur Ayam 1kg" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "font-bold text-white", children: [
                  "Rp26.000 ",
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-white/40 line-through text-[10px]", children: "Rp29.000" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 pt-3 border-t border-white/10 flex items-center justify-between", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[11px] font-semibold text-white/70", children: "Total Penghematan" }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs font-black text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded-lg", children: "Hemat Rp11.500" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute -top-4 right-12 z-20 bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-full text-accent shadow-card animate-float", style: {
            animationDelay: "1s",
            animationDuration: "5s"
          }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.MapPin, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute -bottom-6 left-12 z-20 bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-full text-emerald-400 shadow-card animate-float", style: {
            animationDelay: "2s",
            animationDuration: "7s"
          }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.TrendingDown, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute top-16 -left-4 z-20 bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-full text-white shadow-card animate-float", style: {
            animationDelay: "0.5s",
            animationDuration: "6s"
          }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.PiggyBank, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute bottom-12 -right-4 z-20 bg-white/10 backdrop-blur-md border border-white/15 p-3 rounded-full text-amber-300 shadow-card animate-float", style: {
            animationDelay: "3s",
            animationDuration: "8s"
          }, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.Sparkles, { className: "h-5 w-5" }) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "text-sm text-white/50 relative z-10", children: [
        "\xA9 ",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex items-center justify-center bg-[var(--color-gray-50)] p-6", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "w-full max-w-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Link, { to: "/", className: "mb-8 inline-flex items-center gap-2 text-sm font-bold lg:hidden group", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "grid h-8 w-8 place-items-center rounded-lg bg-gradient-primary text-white shadow-soft group-hover:scale-105 transition-transform duration-200", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.ShoppingBasket, { className: "h-4.5 w-4.5" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "font-display text-lg font-bold text-primary", children: "PasarCek" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Tabs2, { value: activeTab, onValueChange: handleTabChange, children: [
...
function LoginForm() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("form", { onSubmit: submit, className: "space-y-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GoogleButton, { flow: "login" }),
...
function RegisterForm() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("form", { onSubmit: submit, className: "space-y-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(GoogleButton, { flow: "register" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative my-4 text-center text-xs text-[var(--color-gray-500)]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "bg-[var(--color-gray-50)] px-2", children: "atau email" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "absolute inset-x-0 top-1/2 -z-10 h-px bg-[var(--color-gray-100)]" })
    ] }),
