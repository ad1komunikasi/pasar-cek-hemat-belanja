...
function AuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsx(Ctx.Provider, { value: { user, session, profile, roles, isAdmin, loading, refresh }, children });
}
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "my-4 p-3 bg-red-50 border border-red-200 text-red-700 text-xs rounded-md text-left overflow-auto max-h-40", children: [
      /* @__PURE__ */ jsx("p", { className: "font-bold mb-1", children: "Error Details:" }),
      /* @__PURE__ */ jsx("pre", { className: "whitespace-pre-wrap", children: error instanceof Error ? error.message : String(error) }),
      error?.stack && /* @__PURE__ */ jsxs("details", { className: "mt-2", children: [
        /* @__PURE__ */ jsx("summary", { className: "cursor-pointer font-bold", children: "Stack Trace" }),
        /* @__PURE__ */ jsx("pre", { className: "mt-1 text-[10px] opacity-75", children: error.stack })
      ] })
    ] }),
...
const $$splitComponentImporter$w = () => import("./trust-VpOBj95F.js");
...
const $$splitComponentImporter$v = () => import("./reset-password-EqpVsDDE.js");
...
const $$splitComponentImporter$u = () => import("./pricing-B1NNTRjZ.js");
...
const $$splitComponentImporter$t = () => import("./markets-DB6elI7-.js");
...
const $$splitComponentImporter$s = () => import("./features-ORADZ_wk.js");
...
const $$splitComponentImporter$r = () => import("./auth-CPs2--hK.js");
...
const $$splitComponentImporter$q = () => import("./route-BFsOu0JM.js");
...
const $$splitComponentImporter$p = () => import("./index-BkrF_H9u.js");
...
const $$splitComponentImporter$o = () => import("./markets._id-DVGP947V.js");
...
const $$splitComponentImporter$n = () => import("./features._slug-lWVGN9di.js");
...
const $$splitComponentImporter$m = () => import("./smart-basket-DbzX7gdk.js");
...
const $$splitComponentImporter$l = () => import("./settings-f7L2MdCd.js");
...
const $$splitComponentImporter$k = () => import("./profile-CkE9hAuq.js");
...
const $$splitComponentImporter$j = () => import("./prices-C3ukptSG.js");
...
const $$splitComponentImporter$i = () => import("./orders-BE_GmJtd.js");
...
const $$splitComponentImporter$h = () => import("./notifications-BYOgIVNH.js");
...
const $$splitComponentImporter$g = () => import("./favorites-C56iys5v.js");
...
const $$splitComponentImporter$f = () => import("./dashboard-CBctjteL.js");
...
const $$splitComponentImporter$e = () => import("./compare-DpLy3nwQ.js");
...
const $$splitComponentImporter$d = () => import("./checkout-DIfAtcn8.js");
...
const $$splitComponentImporter$c = () => import("./cart-BacHnLLL.js");
...
const $$splitComponentImporter$b = () => import("./admin-iXIuWLhr.js");
...
const $$splitComponentImporter$a = () => import("./admin.index-C3oBerR-.js");
const Route$a = createFileRoute("/_authenticated/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./orders._id-dcRz_IDP.js");
...
const $$splitComponentImporter$8 = () => import("./admin.users-BqTXoXcq.js");
const Route$8 = createFileRoute("/_authenticated/admin/users")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./admin.settings-DA9c358A.js");
const Route$7 = createFileRoute("/_authenticated/admin/settings")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./admin.reports-D0w_7Vx5.js");
const Route$6 = createFileRoute("/_authenticated/admin/reports")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./admin.products-CP97S5jQ.js");
const Route$5 = createFileRoute("/_authenticated/admin/products")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./admin.payments-Dx9tJBhQ.js");
const Route$4 = createFileRoute("/_authenticated/admin/payments")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./admin.packages--Mt8PvaL.js");
const Route$3 = createFileRoute("/_authenticated/admin/packages")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.orders-CAoJsOzU.js");
const Route$2 = createFileRoute("/_authenticated/admin/orders")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.markets-D5oKDiAx.js");
const Route$1 = createFileRoute("/_authenticated/admin/markets")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.auth-monitor-B3xeX4hT.js");
