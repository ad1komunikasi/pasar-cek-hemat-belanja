...
// dist/server/assets/index-BkrF_H9u.js
...
function CTAButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href, className: `${base} ${styles[variant]} ${className}`, children });
}
...
function Navbar() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "sticky top-0 z-50 bg-white/85 backdrop-blur-lg border-b border-border/60", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hidden md:flex items-center gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "/auth", className: "text-sm font-medium text-muted-foreground hover:text-primary transition-colors", children: "Masuk" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "/dashboard", children: "Buka Aplikasi" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setOpen(!open), "aria-label": "Menu", className: "md:hidden p-2 rounded-lg hover:bg-muted", children: open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.X, { className: "h-5 w-5" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.Menu, { className: "h-5 w-5" }) })
    ] }),
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "md:hidden border-t border-border bg-white px-4 py-4 space-y-3", children: [
      links.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: l.href, onClick: () => setOpen(false), className: "block text-sm font-medium text-foreground py-2", children: l.label }, l.href)),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", className: "w-full", children: "Download Gratis" })
    ] })
  ] });
}
function Hero() {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "animate-fade-up", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", children: "Coba Gratis" }),
...
function Features() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "fitur", className: "py-20", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-12 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", children: "Coba Semua Fitur Gratis" }) })
  ] }) });
}
function HowItWorks() {
  const steps = [{
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "py-20 bg-gradient-navy text-white relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-8", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", variant: "white", children: "Coba Smart Basket" }) })
      ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { id: "harga", className: "py-20", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid md:grid-cols-2 gap-6 max-w-4xl mx-auto", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-3xl bg-white border border-border p-8 hover:shadow-card transition-all", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", variant: "secondary", className: "w-full mt-8", children: "Mulai Gratis" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative rounded-3xl bg-gradient-navy text-white p-8 shadow-elevated", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#cta", variant: "white", className: "w-full mt-8", children: "Upgrade Premium" })
      ] })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { id: "cta", className: "py-20 bg-gradient-navy text-white relative overflow-hidden", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CTAButton, { href: "#", variant: "white", children: "Download Gratis" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "#", className: "inline-flex items-center justify-center gap-2 rounded-2xl px-6 py-3 text-sm font-semibold border border-white/30 text-white hover:bg-white/10 transition-all", children: "Gabung Waitlist" })
        ] })
      ] }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", { className: "bg-white border-t border-border py-14", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-8", children: [
      ...
      cols.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "space-y-2", children: c.links.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "#", className: "text-sm text-muted-foreground hover:text-primary transition-colors", children: l }) }, l)) })
      ] }, c.title))
    ] }),
