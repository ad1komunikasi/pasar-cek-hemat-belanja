...
// dist/server/assets/features._slug-BuWc90gW.js
...
function FeatureDetail() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-h-screen bg-[var(--color-gray-50)]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "mx-auto max-w-3xl px-4 py-16", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { asChild: true, className: "mt-8", size: "lg", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, { to: targetLink, children: user ? "Buka Fitur" : "Mulai Gratis" }) })
    ] })
  ] });
}
export {
